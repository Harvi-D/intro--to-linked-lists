 ...
 */
 class Node {
  ...
  /**
   * The `LinkedList` class holds a reference to the `head` node 
   * and has functions that update the list.
   */
  ...
  class LinkedList {
    ...
    /**the added benefit of allowing the caller to insert() a value 
     * after any node in the list. You can do this by passing 
     * in an isMatch() function that matches any node in the list 
     */
